...
export default function Stepper({
    ...
    return (
        <div className={`outer-container ${className}`} {...rest}>
            {/* Stepper indicators - separate container */}
            <div className={`step-circle-container ${stepCircleContainerClassName}`} style={{ border: '1px solid #222' }}>
                ...
                {/* Step info (label + description) */}
                {stepLabels.length > 0 && !isCompleted && (
                    <div style={{ textAlign: 'center', padding: '8px 16px 16px' }}>
                        ...
                        <h2 style={{ color: '#fff', fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '4px' }}>
            ...
            {/* Step content - separate from stepper */}
            <StepContentWrapper
